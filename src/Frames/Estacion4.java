 ...
 */
public class Estacion4 extends javax.swing.JFrame {
      
      String dato="";
      String IP="";
      Timer timer = new Timer();
    public Estacion4(String IP) {
        initComponents();
         this.IP=IP;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Estación N° 4");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setText("Conveyor");
     ...
     boolean pass= true;
        ...
        try {
            FileWriter escribir=new FileWriter(archivo,true);
             ...
             escribir.write("PLC,"+jTextField1.getText()+"#");
            escribir.close();
